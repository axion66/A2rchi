<p align="center">
  <img src="https://raw.githubusercontent.com/mit-submit/archi/main/docs/docs/_static/archi_logo.png" width="200" />
</p>
...
[![Docs](https://img.shields.io/badge/docs-online-blue)](https://mit-submit.github.io/archi/)
...
Follow the [Install](https://mit-submit.github.io/archi/install/) and [Quickstart](https://mit-submit.github.io/archi/quickstart/) guide to set up prerequisites, configure data sources, and launch an instance.

## Contributing

We welcome fixes and new integrations—see the [Developer Guide](https://mit-submit.github.io/archi/developer_guide/) for coding standards, testing instructions, and contribution tips. Please open issues or pull requests on the [GitHub repository](https://github.com/mit-submit/archi).
