...
Usage:
    from src.a2rchi.providers import get_provider, list_enabled_providers
...
def _ensure_providers_registered() -> None:
    ...
    from src.a2rchi.providers.anthropic_provider import AnthropicProvider
    from src.a2rchi.providers.gemini_provider import GeminiProvider
    from src.a2rchi.providers.openrouter_provider import OpenRouterProvider
    from src.a2rchi.providers.local_provider import LocalProvider
